...
Hint: Typically the go-to visualization to show a distribution is a histogram. See the documentation for plotting histograms, customizing axes, and plotting vertical lines as needed.
...
distribution of sale prices grouped by condition
